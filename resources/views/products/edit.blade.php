                      ...
                      <div class="card-body">
                        <form method="POST" action="{{ route('products.update', $product->id) }}">
                            ...
                            <div class="mb-3 row">
                               ...
                               <div class="col-md-6">
                                  <select class="form-control" name="category_id" value="{{ $product->category_id }}" required autocomplete="category_id" autofocus >
                                      {{-- <option selected>{{ $product->category->id }}</option> --}}
